...
export const categories: ProductCategory[] = [
  {
    ...
    products: [
      ...
      { name: "Frango com Requeijão", image: publicImage("frango_requeijao.png"), thumb: publicThumb("frango_requeijao.png") },
      { name: "Frango com Requeijão (massa integral)", image: publicImage("frango_requeijao_integral.png"), thumb: publicThumb("frango_requeijao_integral.png") },
      { name: "Frango, Milho e Bacon", image: publicImage("frango_milho_bacon.png"), thumb: publicThumb("frango_milho_bacon.png") },
      { name: "Frango Premium", image: publicImage("frango_premium.png"), thumb: publicThumb("frango_premium.png") },
      { name: "Mexicana", image: publicImage("mexicana.png"), thumb: publicThumb("mexicana.png") },
